...
<div class="auth-form">
    ...
    <form class="Client-form" action="<?php echo e(route('Client.create')); ?>" method="POST">
        ...
        <input type="text" name="nom" id="nom" placeholder="Entrez votre nom" value="<?php echo e(old('nom')); ?>" required autofocus>
        <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <input type="text" name="prenom" id="prenom" placeholder="Entrez votre prénom" value="<?php echo e(old('prenom')); ?>" required>
